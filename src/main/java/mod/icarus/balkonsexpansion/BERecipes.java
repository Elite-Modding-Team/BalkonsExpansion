...
public class BERecipes {
    ...
    public static IRecipe registerBattleaxeRecipe(ResourceLocation group, Object material, Object stick, Item result) {
        return new ShapedOreRecipe(group, result, "XXX", "X#X", " # ", 'X', material, '#', stick).setRegistryName(BalkonsExpansion.MOD_ID, Objects.requireNonNull(result.getRegistryName()).getPath());
    }
    ...
    public static IRecipe registerBayonetRecipe(ResourceLocation group, Object knife, Item result) {
        return new ShapelessOreRecipe(group, result, BalkonsWeaponMod.musket, knife).setRegistryName(BalkonsExpansion.MOD_ID, Objects.requireNonNull(result.getRegistryName()).getPath());
    }
    ...
    public static IRecipe registerBoomerangRecipe(ResourceLocation group, Object material, Object wood, Item result) {
        return new ShapedOreRecipe(group, result, "##X", "  #", "  #", 'X', material, '#', wood).setRegistryName(BalkonsExpansion.MOD_ID, Objects.requireNonNull(result.getRegistryName()).getPath());
    }
    ...
    public static IRecipe registerConversionRecipe(ResourceLocation group, Object item, Object weapon, Item result) {
        return new ShapelessOreRecipe(group, result, weapon, item).setRegistryName(BalkonsExpansion.MOD_ID, Objects.requireNonNull(result.getRegistryName()).getPath());
    }
    ...
    public static IRecipe registerFlailRecipe(ResourceLocation group, Object material, Object stick, Object string, Item result) {
        return new ShapedOreRecipe(group, result, "  *", " #*", "# X", 'X', material, '#', stick, '*', string).setRegistryName(BalkonsExpansion.MOD_ID, Objects.requireNonNull(result.getRegistryName()).getPath());
    }
    ...
    public static IRecipe registerHalberdRecipe(ResourceLocation group, Object material, Object stick, Item result) {
        return new ShapedOreRecipe(group, result, " XX", " #X", "#  ", 'X', material, '#', stick).setRegistryName(BalkonsExpansion.MOD_ID, Objects.requireNonNull(result.getRegistryName()).getPath());
    }
    ...
    public static IRecipe registerKatanaRecipe(ResourceLocation group, Object material, Object stick, Item result) {
        return new ShapedOreRecipe(group, result, "  X", " X ", "#  ", 'X', material, '#', stick).setRegistryName(BalkonsExpansion.MOD_ID, Objects.requireNonNull(result.getRegistryName()).getPath());
    }
    ...
    public static IRecipe registerKnifeRecipe(ResourceLocation group, Object material, Object stick, Item result) {
        return new ShapedOreRecipe(group, result, "X", "#", 'X', material, '#', stick).setRegistryName(BalkonsExpansion.MOD_ID, Objects.requireNonNull(result.getRegistryName()).getPath());
    }
    ...
    public static IRecipe registerKnifeAltRecipe(ResourceLocation group, Object material, Object stick, Item result) {
        return new ShapedOreRecipe(group, result, "X#", 'X', material, '#', stick).setRegistryName(BalkonsExpansion.MOD_ID, Objects.requireNonNull(result.getRegistryName()).getPath() + ".a");
    }
    ...
    public static IRecipe registerWarhammerRecipe(ResourceLocation group, Object material, Object stick, Item result) {
        return new ShapedOreRecipe(group, result, "X#X", "X#X", " # ", 'X', material, '#', stick).setRegistryName(BalkonsExpansion.MOD_ID, result.getRegistryName().getPath());
    }
}
