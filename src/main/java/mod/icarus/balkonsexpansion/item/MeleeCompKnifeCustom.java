...
// Allows us to set custom attribute amounts for our knives.
public class MeleeCompKnifeCustom extends MeleeCompKnife {
    private float knockbackAmount;

    public MeleeCompKnifeCustom(ToolMaterial material, float knockbackAmount) {
        super(material);
