...
// Allows us to set custom attribute amounts for our boomerangs.
public class MeleeCompBoomerangCustom extends MeleeCompBoomerang {
    private float knockbackAmount;

    public MeleeCompBoomerangCustom(ToolMaterial material, float knockbackAmount) {
        super(material);
