...
// Allows us to set custom attribute amounts for our warhammers.
public class MeleeCompWarhammerCustom extends MeleeCompWarhammer {
    private float knockbackAmount;

    public MeleeCompWarhammerCustom(ToolMaterial material, float knockbackAmount) {
        super(material);
