...
public class IC2ClassicRegistration {
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        ...
        if (BEConfig.ic2_settings.IC2_BRONZE_MATERIAL) {
            ...
            registry.register(halberdBronze = BEItemBuilder.createCustomHalberd("halberd.bronze.ic2c", ToolHelper.bronzeToolMaterial, 0.3F, 1.0F));
            ...
            registry.register(warhammerBronze = BEItemBuilder.createCustomWarhammer("warhammer.bronze.ic2c", ToolHelper.bronzeToolMaterial, 0.4F));
