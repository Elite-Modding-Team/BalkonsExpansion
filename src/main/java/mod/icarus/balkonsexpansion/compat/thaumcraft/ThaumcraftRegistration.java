...
public class ThaumcraftRegistration {
    ...
    public static void registerRecipes(RegistryEvent.Register<IRecipe> event) {
        ResourceLocation thaumiumGroup = new ResourceLocation(Thaumcraft.MODID, "thaumium_stuff");
        ResourceLocation voidGroup = new ResourceLocation(Thaumcraft.MODID, "void_stuff");
        IForgeRegistry<IRecipe> registry = event.getRegistry();

        if (BEConfig.thaumcraft_settings.TC_THAUMIUM_MATERIAL) {
            registry.register(BERecipes.registerBattleaxeRecipe(thaumiumGroup, "ingotThaumium", "stickWood", battleaxeThaumium));
            registry.register(BERecipes.registerBoomerangRecipe(thaumiumGroup, "ingotThaumium", "plankWood", boomerangThaumium));
            registry.register(BERecipes.registerBayonetRecipe(thaumiumGroup, knifeThaumium, bayonetThaumium));
            registry.register(BERecipes.registerFlailRecipe(thaumiumGroup, "ingotThaumium", "stickWood", "string", flailThaumium));
            registry.register(BERecipes.registerHalberdRecipe(thaumiumGroup, "ingotThaumium", "stickWood", halberdThaumium));
            registry.register(BERecipes.registerKatanaRecipe(thaumiumGroup, "ingotThaumium", "stickWood", katanaThaumium));
            registry.register(BERecipes.registerKnifeRecipe(thaumiumGroup, "ingotThaumium", "stickWood", knifeThaumium));
            registry.register(BERecipes.registerKnifeAltRecipe(thaumiumGroup, "ingotThaumium", "stickWood", knifeThaumium));
            registry.register(BERecipes.registerSpearRecipe(thaumiumGroup, "ingotThaumium", "stickWood", spearThaumium));
            registry.register(BERecipes.registerWarhammerRecipe(thaumiumGroup, "ingotThaumium", "stickWood", warhammerThaumium));
        ...
        if (BEConfig.thaumcraft_settings.TC_VOID_MATERIAL) {
            registry.register(BERecipes.registerBattleaxeRecipe(voidGroup, "ingotVoid", "stickWood", battleaxeVoid));
            registry.register(BERecipes.registerBoomerangRecipe(voidGroup, "ingotVoid", ItemsTC.voidSeed, boomerangVoid));
            //registry.register(BERecipes.registerBayonetRecipe(voidGroup, knifeVoid, bayonetVoid));
            registry.register(BERecipes.registerFlailRecipe(voidGroup, "ingotVoid", "stickWood", "string", flailVoid));
            registry.register(BERecipes.registerHalberdRecipe(voidGroup, "ingotVoid", "stickWood", halberdVoid));
            registry.register(BERecipes.registerKatanaRecipe(voidGroup, "ingotVoid", "stickWood", katanaVoid));
            registry.register(BERecipes.registerKnifeRecipe(voidGroup, "ingotVoid", "stickWood", knifeVoid));
            registry.register(BERecipes.registerKnifeAltRecipe(voidGroup, "ingotVoid", "stickWood", knifeVoid));
            registry.register(BERecipes.registerSpearRecipe(voidGroup, "ingotVoid", "stickWood", spearVoid));
            registry.register(BERecipes.registerWarhammerRecipe(voidGroup, "ingotVoid", "stickWood", warhammerVoid));
