...
public class DefiledLandsRegistration {
    ...
    public static void registerRecipes(RegistryEvent.Register<IRecipe> event) {
        ...
        if (BEConfig.defiled_lands_settings.DL_UMBRIUM_MATERIAL) {
            registry.register(BERecipes.registerBattleaxeRecipe(defaultGroup, "ingotUmbrium", "stickWood", battleaxeUmbrium));
            registry.register(BERecipes.registerBoomerangRecipe(defaultGroup, "ingotUmbrium", "plankWood", boomerangUmbrium));
            registry.register(BERecipes.registerBayonetRecipe(defaultGroup, knifeUmbrium, bayonetUmbrium));
            registry.register(BERecipes.registerFlailRecipe(defaultGroup, "ingotUmbrium", "stickWood", "string", flailUmbrium));
            registry.register(BERecipes.registerHalberdRecipe(defaultGroup, "ingotUmbrium", "stickWood", halberdUmbrium));
            registry.register(BERecipes.registerKatanaRecipe(defaultGroup, "ingotUmbrium", "stickWood", katanaUmbrium));
            registry.register(BERecipes.registerKnifeRecipe(defaultGroup, "ingotUmbrium", "stickWood", knifeUmbrium));
            registry.register(BERecipes.registerKnifeAltRecipe(defaultGroup, "ingotUmbrium", "stickWood", knifeUmbrium));
            registry.register(BERecipes.registerSpearRecipe(defaultGroup, "ingotUmbrium", "stickWood", spearUmbrium));
            registry.register(BERecipes.registerWarhammerRecipe(defaultGroup, "ingotUmbrium", "stickWood", warhammerUmbrium));
